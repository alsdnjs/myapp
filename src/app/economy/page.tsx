  ...
  useEffect(() => {
    const loadNews = async () => {
      ...
      try {
        ...
        const newsData = await fetchNaverNews('economy');
        ...
        <div className="relative">
          ...
          <div className="w-full h-[600px] relative overflow-hidden">
            ...
            <div className="absolute inset-0 bg-[#e3e6f3] flex items-center justify-center overflow-hidden">
              <div className="text-8xl font-bold text-white opacity-20">Economy News</div>
              {/* 어두운 그라데이션 오버레이 */}
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center text-center text-white z-10">
              <div className="container mx-auto px-4">
                <h1 className="text-5xl font-bold mb-6">글로벌 경제 위기, 한국 경제의 새로운 도약</h1>
                <p className="text-xl max-w-4xl mx-auto mb-8 leading-relaxed">
                  세계 경제의 불확실성이 커지는 가운데, 한국 경제는 새로운 도약을 준비하고 있습니다. 반도체 산업을 중심으로 한 첨단 기술 산업의 성장과 함께, 지속 가능한 경제 성장 모델을 찾아가는 과정에서...
                </p>
                ...
                <div className="mt-6 text-gray-300">경제 · 2시간 전 · 조회수 1k</div>
              </div>
            </div>
          </div>
